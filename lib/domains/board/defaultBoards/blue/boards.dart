...
final _defaultBlueAlpha = BoardQuarterBlue.from(
  goals: {
...
final _defaultBlueBeta = BoardQuarterBlue.from(
  goals: {
    const Position(x: 6, y: 4): const Goal(
      color: RobotColors.yellow,
      type: GoalTypes.moon,
    ),
    const Position(x: 2, y: 6): const Goal(
      color: RobotColors.blue,
      type: GoalTypes.sun,
    ),
...
final _defaultBlueGamma = BoardQuarterBlue.from(
  goals: {
    const Position(x: 3, y: 2): const Goal(
      color: RobotColors.yellow,
      type: GoalTypes.moon,
    ),
    const Position(x: 5, y: 3): const Goal(
      color: RobotColors.blue,
      type: GoalTypes.sun,
    ),
  ...
  verticalWalls: {
    const WallPosition(x: 6, y: 0),
    const WallPosition(x: 3, y: 2),
