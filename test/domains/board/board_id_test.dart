  ...
  group('BoardId', () {
    test('from', () {
      ...
      final robotPositions = Map.fromEntries([
        ...
        const MapEntry(RobotColors.blue, Position(x: 1, y: 9)),
        const MapEntry(RobotColors.green, Position(x: 7, y: 15)),
      ...
      expect(
        boardId.value,
        '',
      );
    });
  });
}
